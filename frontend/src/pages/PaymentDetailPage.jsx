...
import {
  formatCurrency,
  getTipoPagoStr as getTipoPagoStrUtil,
  formatDate,
  validateFile,
...
const handleClipboardPaste = async (e, callback) => {
  ...
  try {
    ...
    callback(
      null,
      "No se pudo acceder al portapapeles. Asegurate de dar permisos o usá el botón de selección de archivos.",
    );
  }
};
...
export default function PaymentDetailPage({ user }) {
  ...
  const uploadPendingDocs = async () => {
    ...
    try {
      ...
      for (const file of pendingDocs) {
        if (commentId) {
          await api.uploadDocumentWithComment(
            id,
            commentId,
            file,
            "peticion",
      ...
      loadPayment();
      addToast(
        "Documento(s) subido(s) y registrado(s) correctamente",
        "success",
      );
    } catch (err) {
  ...
  const handleAdvance = async () => {
    if (!actionComment.trim()) {
      addToast(
        "Debes escribir un comentario para avanzar el workflow",
        "warning",
      );
      return;
    }
    ...
    try {
      ...
      const result = await api.advanceWorkflow(
        id,
        actionModal.area,
        comentario,
      );
  ...
  const handleCancel = async () => {
    const confirmed = await showConfirm(
      "¿Cancelar esta petición? Esta acción no se puede deshacer.",
    );
    if (!confirmed) return;
    try {
  ...
  const handleDelete = async () => {
    const confirmed = await showConfirm(
      "¿Eliminar esta petición definitivamente? Esta acción no se puede deshacer.",
    );
    if (!confirmed) return;
    try {
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      addToast(
        "Error actualizando la petición: " + (err.message || ""),
        "error",
      );
    }
  };
        ...
        <div className="flex gap-1">
          {(() => {
            if (payment.estado_general === "CANCELADA") {
              return (
                <span
                  className="badge badge-cancelada"
            ...
            if (payment.estado_general === "COMPLETADA") {
              return (
                <span
                  className="badge badge-completada"
                  style={{ alignSelf: "center" }}
                >
                  COMPLETADA
                </span>
            ...
            const nextPending = sortedWorkflowStates.find(
              (s) => s.estado === "PENDIENTE",
            );
            if (nextPending) {
              return (
                <span
                  className="badge badge-en_proceso"
                  style={{ alignSelf: "center" }}
                >
            ...
            return (
              <span
                className={`badge badge-${payment.estado_general.toLowerCase()}`}
                style={{ alignSelf: "center" }}
              >
          ...
          <div className="card">
            ...
            {!editingPayment && (
              <div className="payment-info-grid">
                ...
                <div className="payment-info-item">
                  ...
                  <div className="payment-info-value">
                    {getTipoPagoStr(payment.tipo_pago) === "SIN_FACTURA"
                      ? "Sin Factura"
                      : "Con Factura"}
                  </div>
                </div>
                <div className="payment-info-item highlight">
                  ...
                  <div className="payment-info-value">
                    {formatDate(payment.fecha_pago, false)}
                  </div>
                </div>
                <div className="payment-info-item">
                ...
                <div className="payment-info-item">
                  ...
                  <div className="payment-info-value">
                    {getMedioPagoDisplay(payment.medio_pago) || "-"}
                  </div>
                </div>
                <div className="payment-info-item highlight">
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditForm({
                        ...editForm,
                        propuesta_gasto: e.target.value,
                      })
                    }
                  />
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditForm({ ...editForm, orden_pago: e.target.value })
                    }
                  />
                </div>
              </div>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditForm({
                        ...editForm,
                        n_documento_contable: e.target.value,
                      })
                    }
                  />
                </div>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEditForm({ ...editForm, tipo_pago: e.target.value })
                    }
                  >
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEditForm({ ...editForm, medio_pago: e.target.value })
                    }
                  >
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditForm({ ...editForm, monto_total: e.target.value })
                    }
                  />
                </div>
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEditForm({ ...editForm, divisa: e.target.value })
                    }
                  >
            ...
            {editingPayment && (
              <div className="flex gap-1 mt-3">
                ...
                <button className="btn btn-warning" onClick={handleCancelEdit}>
                  Cancelar
                </button>
              </div>
            )}
          ...
          <div className="modal">
            <div className="modal-header">
              <h3 className="modal-title">
                {actionModal.type === "advance"
                  ? AREA_ACTIONS[actionModal.area]
                  : "Revertir"}{" "}
                - {AREAS_DISPLAY[actionModal.area]}
              </h3>
              <button
            ...
            {actionModal.type === "advance" && (
              <div className="form-group">
                <div
                  ...
                  onClick={() =>
                    document.getElementById("action-file-input")?.click()
                  }
                  onDragOver={(e) => {
                    e.preventDefault();
                    setActionDragOver(true);
                  }}
                  ...
                  onDrop={(e) => {
                    ...
                    if (validFiles.length > 0)
                      setActionDocuments((prev) => [...prev, ...validFiles]);
                  }}
                ...
                >
                  ...
                  >
                    También puedes pegar (Ctrl+V) en cualquier parte de esta
                    ventana
                  </p>
                </div>
                <input
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                onClick={
                  actionModal.type === "advance" ? handleAdvance : handleReverse
                }
              ...
              >
                {actionLoading
                  ? "Procesando..."
                  : actionModal.type === "advance"
                    ? AREA_ACTIONS[actionModal.area] || "Confirmar"
                    : "Revertir"}
              </button>
            </div>
          </div>
      ...
      {docUploadModal && (
        <div className="modal-overlay">
          <div className="modal">
            ...
            <div className="form-group">
              <label className="form-label">
                Área que registra el documento
              </label>
              {user?.role === "admin" ? (
                <select
                  className="form-select"
                ...
                >
                  {AREA_ICONS[user?.accessible_areas?.[0]]}{" "}
                  {AREAS_DISPLAY[user?.accessible_areas?.[0]] ||
                    user?.accessible_areas?.[0]}
                  <span
                    style={{
                      fontSize: "0.75rem",
                      marginLeft: "0.5rem",
            ...
            <div className="form-group">
              <div
                ...
                onClick={() =>
                  document.getElementById("pending-doc-input")?.click()
                }
                onDragOver={(e) => {
                  e.preventDefault();
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                disabled={
                  uploadingPending ||
                  pendingDocs.length === 0 ||
                  (user?.role === "admin" && !uploadArea)
                }
              >
                {uploadingPending
                  ? "Subiendo..."
                  : `Subir ${pendingDocs.length} archivo(s)`}
              </button>
            </div>
          </div>
        </div>
